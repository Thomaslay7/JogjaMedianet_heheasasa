...
public class Register extends AppCompatActivity {
    ...
    EditText txt_username, txt_password, txt_confirm_password,txt_namadepan,txt_namabelakang,txt_jabatan;
    Intent intent;
        ...
        btn_register.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (conMgr.getActiveNetworkInfo() != null
                        && conMgr.getActiveNetworkInfo().isAvailable()
                        && conMgr.getActiveNetworkInfo().isConnected()) {
                    checkRegister(namadepan,namabelakang,jabatan,jeniskelaminS,username, password, confirm_password);
                } else {
    ...
    private void checkRegister(final String namadepan,final String namabelakang,final String jabatan, final String jk,final String username, final String password, final String confirm_password) {
